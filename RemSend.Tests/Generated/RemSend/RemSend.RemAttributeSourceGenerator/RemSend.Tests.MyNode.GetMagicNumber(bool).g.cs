...
partial class MyNode {
    ...
    /// Set <paramref name="PeerId"/> to 1 to send to the authority.
    /// </summary>
    public async System.Threading.Tasks.Task<ushort> RequestGetMagicNumber(int PeerId, TimeSpan Timeout, bool Dummy, CancellationToken CancellationToken = default) {
        // Generate request ID
