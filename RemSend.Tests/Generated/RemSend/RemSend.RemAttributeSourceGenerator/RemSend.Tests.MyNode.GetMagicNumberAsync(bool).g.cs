...
partial class MyNode {
    ...
    /// <summary>
    /// Remotely calls <see cref="GetMagicNumberAsync(bool)"/> on the given peer, using the given packet if possible.<br/>
    ...
    public void SendGetMagicNumberAsync(int PeerId, bool Dummy) {
        ...
        // Send packet to peer
        SendGetMagicNumberAsync(PeerId, SerializedRemPacket, @Dummy);
    }
